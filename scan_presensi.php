...
<body id="page-top">
  ...
  <div id="content-wrapper" class="d-flex flex-column pt-5">
    ...
    <div id="content" class="container">
      ...
      <!-- Teks instruksi awal -->
      <h5 id="displayText" class="alert alert-secondary text-center mb-5">
          ...
          <div class="row align-items-stretch">
            <div class="col-md-7 pl-4">
              <table class="table table-borderless mb-0">
                <tr>
                  <th class="font-weight-bold" style="width:35%;">Jenis Presensi</th>
                  <td style="width:5%;">:</td>
                  <td>${data.jenisPresensi}</td>
                </tr>
                <tr>
            ...
            <div class="col-md-5 pr-4 d-flex align-items-center justify-content-end">
              <img src="data/foto/foto_presensi_siswa/${foto}" alt="Bukti Presensi" class="img-fluid" style="max-height: 200px;">
            </div>
          </div>`;
