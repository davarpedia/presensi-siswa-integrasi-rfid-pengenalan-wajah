<?php 
$pageTitle = "Tambah Dataset Wajah";
...
if (empty($id)) {
    ...
    $query = "SELECT nis, nama, no_rfid FROM siswa WHERE id = ?";
...
$flask_url = "http://localhost:5000"; // Sesuaikan jika Flask berjalan di server lain
?>
...
<div class="container-fluid">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Tambah Dataset Wajah</h1>
  ...
  <div class="mb-4">
    <nav aria-label="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="tambah_siswa.php">Tambah Siswa</a></li>
        <li class="breadcrumb-item active" aria-current="page">Tambah Dataset Wajah</li>
        </ol>
    </nav>
  </div>
  ...
  <?php else: ?>
    ...
    <div class="text-center">
        ...
        <button id="retryButton" class="btn btn-danger mb-4 mr-1" style="display:none;">Ulangi Capture</button>
    ...
    <script>
      ...
      // Tombol "Lakukan Embedding": ketika diklik, memicu endpoint /add_face_data dengan data baru, lalu redirect
      document.getElementById("embeddingButton").addEventListener("click", function() {
          ...
          .then(data => {
              if (data.error) {
                  ...
                  // Setelah penambahan selesai, redirect ke halaman utama
                  setTimeout(function(){
